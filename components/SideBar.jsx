            ...
            <View className='mt-10 flex-row'>
                ...
                <Pressable onPress={() => setSaved(!saved)} className="w-7 ml-2 items-end">
                    ...
                    <svg height="30" viewBox="0 0 21 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                        {saved ? (
                            <path d="M1 24.8884V3.10735C1 1.94349 1.81015 1 2.80952 1H18.1905C19.1898 1 20 1.94349 20 3.10735V24.8884C20 26.7659 18.0509 27.7061 16.9109 26.3785L11.7795 20.4026C11.0729 19.5796 9.92714 19.5796 9.22047 20.4026L4.08905 26.3785C2.94911 27.7061 1 26.7659 1 24.8884Z" fill="#ccc" stroke="#ccc"/>
                        ) : (
